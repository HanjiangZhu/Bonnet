...
class BallQuery(nn.Module):
    ...
    def forward(self, points_coords, centers_coords, points_features=None):
        ...
        neighbor_indices = modules_F.ball_query(centers_coords, points_coords, self.radius, self.num_neighbors)
        neighbor_coordinates = modules_F.grouping(points_coords, neighbor_indices)
        ...
        if points_features is None:
            ...
            neighbor_features = modules_F.grouping(points_features, neighbor_indices)
